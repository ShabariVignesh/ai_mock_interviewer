...
def interview_page():
    ...
    st.session_state.selected_model = st.sidebar.selectbox("Select Model", ["llama3-70b-8192", "Finetuned-llama-3-8b", "Finetuned-Microsoft-Phi-3", "Finetuned-Deepseek-R1","Finetuned-Gemma"])

...
def generate_report():
    ...
    report_prompt = f"Analyze the following interview data and provide feedback on accuracy and suggestions and provide me f1 score, rouge score, BLEU score each:\n\n{json.dumps(enriched_data, indent=2)}"
